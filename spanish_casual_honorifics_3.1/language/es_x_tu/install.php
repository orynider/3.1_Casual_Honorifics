...
$lang = array_merge($lang, array(
	...
	'CONVERT_COMPLETE_EXPLAIN'	=> 'Ha convertido su sitio a phpBB 3.1 correctamente. Ahora puede identificarse y <a href="../">acceder a su sitio</a>. Recuerde que hay ayuda disponible en línea para usar phpBB3 vía <a href="https://www.phpbb.com/support/documentation/3.0/">Documentación</a>, <a href="https://www.phpbb.com/community/viewforum.php?f=46">foro de soporte</a> (ambos en inglés).',
	...
	'INSTALL_CONGRATS_EXPLAIN'	=> '		
		...
		<p>Haciendo clic en el botón de abajo llegará a un formulario para enviar información estadística a phpBB en su Panel de Control de Administración (PCA). Le estaríamos muy agradecidos si pudiera ayudarnos enviándonos esa información. Después podría tomarse algún tiempo para examinar las opciones disponibles para usted. Recuerde que hay disponible ayuda en línea mediante <a href="https://www.phpbb.com/support/documentation/3.0/">Documentación</a>, <a href="https://www.phpbb.com/community/viewforum.php?f=46">foros de soporte</a> (ambos en inglés), lea el documento <a href="%3$s">LEAME</a> para más información.</p><p><strong>Por favor borre, mueva o renombre la carpeta install antes de usar su sitio. Si esta carpeta se encuentra presente, solamente el Panel de Control de Administración (PCA) será accesible.</strong>',
	...
	'MYSQL_SCHEMA_UPDATE_REQUIRED'   => 'El schema de su base de datos MySQL para phpBB quedó obsoleto. phpBB detectó un schema para MySQL 3.x/4.x, pero el servidor funciona con MySQL %2$s.<br /><strong>Antes de que proceda a la actualización necesita actualizar el schema.</strong><br /><br />Por favor, consulte este artículo (en inglés) <a href="https://www.phpbb.com/kb/article/doesnt-have-a-default-value-errors/">Knowledge Base article about upgrading the MySQL schema</a>. Si encuentra problemas o no se defiende con el inglés, por favor acuda al <a href="https://www.phpbb.com/community/viewforum.php?f=46">foros de soporte</a> (en inglés).',
