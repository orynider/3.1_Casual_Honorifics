...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_INACTIVE'				=> 'Tu cuenta ha sido creada. Sin embargo, este foro requiere activación de cuenta, una contraseña de activación ha sido enviada a la dirección de email que has introducido. Por favor, revisa tu correo electrónico para obtener más información y también asegúrate de comprobar tu buzón de correo no deseado. Puede tardar un tiempo el conseguir el correo electrónico en función de tu proveedor de correo electrónico.',
