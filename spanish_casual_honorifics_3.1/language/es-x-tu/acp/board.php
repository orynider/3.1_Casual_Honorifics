...
// Cookie Settings
$lang = array_merge($lang, array(
	'ACP_COOKIE_SETTINGS_EXPLAIN'	=> 'Estos detalles determinan los datos usados para enviar cookies a los navegadores de los usuarios. En la mayoría de los casos los valores por defecto para los configuración de las cookies deberían ser suficiente. Si necesitas cambiar algo, debes hacerlo con cuidado, parámetros incorrectos impedirían que los usuarios puedan identificarse. Si tienes problemas para que los usuarios mantengan la sesión correctamente en tu foro, visita la página (en Inglés) <b><a href="https://www.phpbb.com/support/go/cookie-settings/">phpBB.com Knowledge Base - Fixing incorrect cookie settings</a></b>.',

	'COOKIE_DOMAIN'				=> 'Dominio de la cookie',
	'COOKIE_DOMAIN_EXPLAIN'		=> 'En la mayoría de los casos, el dominio de cookies es opcional. Puedes dejarlo en blanco si no estás seguro.<br /><br /> En el caso de tener un foro integrado con otro software, o tienes varios dominios, entonces para determinar el dominio de la cookie que necesitas, debes hacer lo siguiente. Si tienes algo como <i>example.com</i> y <i>forums.example.com</i>, o quizás <i>forums.example.com</i> y <i>blog.example.com</i>. Elimina los subdominios hasta encontrar el dominio común, <i>example.com</i>. Ahora agrega un punto delante del dominio común e introduce .example.com (ten en cuenta el punto al principio).',
	'COOKIE_NAME'				=> 'Nombre de la cookie',
	'COOKIE_NAME_EXPLAIN'		=> 'Esto puede ser cualquier cosa que quieras, que sea original. Siempre que se cambie la configuración de la cookie, se debe cambiar el nombre de la cookie.',
	'COOKIE_PATH'				=> 'Ruta de la cookie',
	'COOKIE_PATH_EXPLAIN'		=> 'Ten en cuenta que siempre se trata de una barra, no importa cuál sea la dirección URL de tu foro.',
...
$lang = array_merge($lang, array(
	...
	'SMTP_PASSWORD_EXPLAIN'			=> 'Introduzca una contraseña solo si tu servidor SMTP lo requiere.<br /><em><strong>ADVERTENCIA:</strong> Esta contraseña será guardada como texto plano en la base de datos y será visible para cualquiera que tenga acceso a la misma o que pueda ver esta página de configuración.</em>',
	'SMTP_PLAIN'					=> 'PLAIN',
	...
	'SMTP_SERVER_EXPLAIN'			=> 'Tenga en cuenta que usted tiene que proporcionar el protocolo que utiliza el servidor. Si está utilizando SSL, esto tiene que ser "ssl: //your.mail server.com"',
